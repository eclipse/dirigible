...
sap.ui.define([
	...
	function(Label, Popover, DateFormat, Fragment, Controller, JSONModel, Log) {
		...
		return Controller.extend("sap.m.sample.PlanningCalendarModifyAppointments.controller.Page", {
			...
			_arrangeDialogFragment: function (iDialogType) {
				if (!this._oNewAppointmentDialog) {
					Fragment.load({
						id: "dialogFrag",
						name: "sap.m.sample.PlanningCalendarModifyAppointments.view.Create",
						controller: this
			...
			_handleSingleAppointment: function (oAppointment) {
				...
				if (!this._oDetailsPopover) {
					this._oDetailsPopover = Fragment.load({
						id: "myPopoverFrag",
						name: "sap.m.sample.PlanningCalendarModifyAppointments.view.Details",
						controller: this
					}).then(function(oDialog){
