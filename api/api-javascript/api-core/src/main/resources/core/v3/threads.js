 ...
 */
/**
 * Threads module can be used only with Mozilla Rhino engine
 */

const rhino_only = "Threads module can be used only with Mozilla Rhino engine";
/**
 * Creates a new Thread by a runnable function and a name
 */
exports.create = function(runnable, name) {
	if (__engine !== 'rhino') {
		console.error(rhino_only);
		throw new Error(rhino_only);
	}
