declare module "@dirigible/platform" {
    ...
    module engines {
        interface Engine {
             ...
             * @param context
             */
            execute(module, context):object;

            /**
             * Executes a given source code with a given context
             * @param module
             * @param context
             */
            executeCode(module, context):object;
        }
    ...
    module lifecycle {
         ...
         * @param project
         */
        function unpublish(user, workspace, project):boolean;
    }
    module registry {
        /**
