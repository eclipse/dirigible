...
public class GitConnector implements IGitConnector {
  ...
  public void pull(String username, String password)
      throws WrongRepositoryStateException, InvalidConfigurationException, DetachedHeadException, InvalidRemoteException, CanceledException,
    ...
    try {
      ...
      try {
        for (Ref branch : branches) {
          ...
          GitBranch gitBranch = new GitBranch(shortLocalBranchName, false, currentBranch.equals(shortLocalBranchName), commit.getId()
                                                                                                                             .getName(),
              commit.getId()
                    .abbreviate(7)
                    .name(),
