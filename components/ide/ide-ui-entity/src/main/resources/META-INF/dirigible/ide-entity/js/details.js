            ...
            if (!$scope.state.error) {
                ...
                if ($scope.dialogType === 'entity') {
                    ...
                    messageHub.postMessage('edm.editor.property', {
                        ...
                        widgetDropDownDependsOn: $scope.dataParameters.widgetDependsOnProperty,
                        widgetDropDownDependsOn: $scope.dataParameters.widgetDependsOnEntity,
                        widgetDropDownDependsOn: $scope.dataParameters.widgetDependsOnValueFrom,
                        widgetDropDownDependsOn: $scope.dataParameters.widgetDependsOnFilterBy,
