...
public class Problem {
  ...
  public String toString() {
    return "Problem [id=" + id + ", location=" + location + ", type=" + type + ", line=" + line + ", column=" + column + ", cause=" + cause
        + ", expected=" + expected + ", createdAt=" + createdAt + ", createdBy=" + createdBy + ", category=" + category + ", module="
        + module + ", source=" + source + ", program=" + program + ", status=" + status + "]";
  }
