...
exports.getDialect = function(connection) {
	...
	let native;
	if (connection) {
		native = org.eclipse.dirigible.components.api.db.DatabaseFacade.getNative(connection.native);
	} else {
		native = org.eclipse.dirigible.components.api.db.DatabaseFacade.getDefault();
	}
