...
export class Pdf {
    public static generateTable(data: TemplateParametersType, config: TemplateParametersType) {
        ...
        this.setTemplateParameters(templateParameters, config);
    ...
    public static generate(templatePath: string, data: TemplateParametersType) {
    ...
    private static setTemplateParameters(templateParameters: TemplateParametersType, config: TemplateParametersType) {
        this.setDocumentSize(templateParameters, config);
        this.setDocumentAlign(templateParameters, config);
    }

    private static setDocumentAlign(templateParameters: TemplateParametersType, config: TemplateParametersType) {
    ...
    private static setDocumentSize(templateParameters: TemplateParametersType, config: TemplateParametersType) {
