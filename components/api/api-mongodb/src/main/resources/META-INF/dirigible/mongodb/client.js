...
exports.createBasicDBObject = function() {
	...
	var native = org.eclipse.dirigible.components.api.mongodb.MongoDBFacade.createBasicDBObject();
...
function Client() {
	...
	this.getDB = function(name) {
		...
		if (name) {
			...
			var defaultDB = org.eclipse.dirigible.components.api.mongodb.MongoDBFacade.getDefaultDatabaseName();
