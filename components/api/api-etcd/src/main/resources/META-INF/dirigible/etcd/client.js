...
exports.getClient = function () {
    ...
    client.native = org.eclipse.dirigible.components.api.etcd.EtcdFacade.getClient();
    return client;
};
...
function StringToByteSequence(str) {
    return org.eclipse.dirigible.components.api.etcd.EtcdFacade.stringToByteSequence(str);
}

function ByteArrayToByteSequence(arr) {
    return org.eclipse.dirigible.components.api.etcd.EtcdFacade.byteArrayToByteSequence(arr);
}

function ByteSequenceToString(value) {
    return org.eclipse.dirigible.components.api.etcd.EtcdFacade.byteSequenceToString(value);
}
