...
exports.md5AsNativeBytes = function(input) {
	...
	const output = org.eclipse.dirigible.components.api.utils.DigestFacade.md5(native);
	return output;
};
...
exports.md5Hex = function(input) {
	...
	const output = org.eclipse.dirigible.components.api.utils.DigestFacade.md5Hex(native);
	return output;
};
...
exports.sha1AsNativeBytes = function(input) {
	...
	const output = org.eclipse.dirigible.components.api.utils.DigestFacade.sha1(native);
	return output;
};
...
exports.sha256AsNativeBytes = function(input) {
	...
	const output = org.eclipse.dirigible.components.api.utils.DigestFacade.sha256(native);
	return output;
};
...
exports.sha384AsNativeBytes = function(input) {
	...
	const output = org.eclipse.dirigible.components.api.utils.DigestFacade.sha384(native);
	return output;
};
...
exports.sha512AsNativeBytes = function(input) {
	...
	const output = org.eclipse.dirigible.components.api.utils.DigestFacade.sha512(native);
	return output;
};
...
exports.sha1Hex = function(input) {
	...
	const output = org.eclipse.dirigible.components.api.utils.DigestFacade.sha1Hex(native);
	return output;
};
