 ...
 */
package org.eclipse.dirigible.components.data.metadata.load;
 ...
 */
@Component
public class DataSourceMetadataLoader {
     ...
     * @throws SQLException the SQL exception
     */
    public Table getTableMetadata(String schemaName, String tableName, DataSource dataSource) throws SQLException {
    	if (dataSource == null) {
	...
	public List<Table> getSchemaMetadata(String schema, DataSource datasource) throws SQLException {
		...
		if (tableNames != null) {
			for (String tableName : tableNames) {
				Table tableModel = getTableMetadata(schema, tableName, datasource);
