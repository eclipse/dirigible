...
public class NoSQLTableMetadata {
  ...
  public NoSQLTableMetadata(String name, String type, String remarks, Connection connection, String catalogName, String schemaName,
    ...
    try {
      ...
      while (rs.next()) {
        NoSQLColumnMetadata column =
            new NoSQLColumnMetadata(rs.getString(DatabaseMetadataHelper.COLUMN_NAME), rs.getString(DatabaseMetadataHelper.TYPE_NAME),
                rs.getInt(DatabaseMetadataHelper.COLUMN_SIZE), rs.getBoolean(DatabaseMetadataHelper.IS_NULLABLE),
                rs.getBoolean(DatabaseMetadataHelper.PK), rs.getInt(DatabaseMetadataHelper.DECIMAL_DIGITS));
