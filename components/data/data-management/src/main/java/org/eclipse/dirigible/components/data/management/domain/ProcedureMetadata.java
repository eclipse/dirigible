...
import org.eclipse.dirigible.components.data.management.helpers.DatabaseMetadataHelper.ProcedureColumnsIteratorCallback;
  ...
  public ProcedureMetadata(String name, String type, String remarks, Connection connection, String catalogName, String schemaName,
    ...
    if (deep) {
      DatabaseMetadataHelper.iterateProcedureDefinition(connection, catalogName, schemaName, name, new ProcedureColumnsIteratorCallback() {
        @Override
        public void onProcedureColumn(String name, int kind, String type, int precision, int length, int scale, int radix, boolean nullable,
            String remarks) {
