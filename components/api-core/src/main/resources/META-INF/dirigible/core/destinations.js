...
let oauth = require("security/oauth");

exports.get = function (name) {
    if (isCloudEnvironment()) {
        return JSON.parse(getCloudDestination(name));
    }
    return JSON.parse(org.eclipse.dirigible.components.api.core.DestinationsFacade.get(name));
};
...
exports.set = function (name, destination) {
    ...
    org.eclipse.dirigible.components.api.core.DestinationsFacade.set(name, JSON.stringify(destination));
};
