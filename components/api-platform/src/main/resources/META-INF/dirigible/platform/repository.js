...
exports.getResource = function(path) {
	const resourceInstance = org.eclipse.dirigible.components.api.platform.RepositoryFacade.getResource(path);
...
exports.createResource = function(path, content, contentType) {
	const resourceInstance = org.eclipse.dirigible.components.api.platform.RepositoryFacade.createResource(path, content, contentType);
	const resource = new Resource();
	resource.native = resourceInstance;
	return resource;
};
...
exports.createResourceNative = function(path, content, contentType) {
	const resourceInstance = org.eclipse.dirigible.components.api.platform.RepositoryFacade.createResourceNative(path, content, contentType);
	const resource = new Resource();
	resource.native = resourceInstance;
	return resource;
};
...
exports.updateResource = function(path, content) {
	const resourceInstance = org.eclipse.dirigible.components.api.platform.RepositoryFacade.updateResource(path, content);
	const resource = new Resource();
	resource.native = resourceInstance;
	return resource;
};
...
exports.updateResourceNative = function(path, content) {
	const resourceInstance = org.eclipse.dirigible.components.api.platform.RepositoryFacade.updateResourceNative(path, content);
	const resource = new Resource();
	resource.native = resourceInstance;
	return resource;
};
...
exports.deleteResource = function(path) {
	org.eclipse.dirigible.components.api.platform.RepositoryFacade.deleteResource(path);
};

exports.getCollection = function(path) {
	const collectionInstnace = org.eclipse.dirigible.components.api.platform.RepositoryFacade.getCollection(path);
...
exports.createCollection = function(path) {
	const collectionInstnace = org.eclipse.dirigible.components.api.platform.RepositoryFacade.createCollection(path);
	const collection = new Collection();
	collection.native = collectionInstnace;
	return collection;
};
...
exports.deleteCollection = function(path) {
	org.eclipse.dirigible.components.api.platform.RepositoryFacade.deleteCollection(path);
};

exports.find = function(path, pattern) {
	return JSON.parse(org.eclipse.dirigible.components.api.platform.RepositoryFacade.find(path, pattern));
};
