...
public class JobLog extends Artefact {
  ...
  public String toString() {
    return "JobLog{" + "id=" + id + ", jobName=" + jobName + ", handler=" + handler + ", triggeredAt=" + triggeredAt + ", triggeredId="
        + triggeredId + ", finishedAt=" + finishedAt + ", status=" + status + ", message=" + message + ", location=" + location + ", name="
        + name + ", type=" + type + ", description=" + description + ", key=" + key + ", dependencies=" + dependencies + ", createdBy="
