...
let templateEngine = require("template/engines");
...
exports.generateTable = function (data, config) {
    ...
    return org.eclipse.dirigible.components.api.pdf.PDFFacade.generate(pdfTemplate, xmlData);
};
...
exports.generate = function (templatePath, data) {
    ...
    return org.eclipse.dirigible.components.api.pdf.PDFFacade.generate(template, xmlData);
};
