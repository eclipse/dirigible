...
exports.getDataSources = function () {
	const datasources = org.eclipse.dirigible.components.api.db.DatabaseFacade.getDataSources();
	if (datasources) {
...
exports.getMetadata = function (datasourceName) {
	let metadata;
	if (datasourceName) {
		metadata = org.eclipse.dirigible.components.api.db.DatabaseFacade.getMetadata(datasourceName);
	} else {
		metadata = org.eclipse.dirigible.components.api.db.DatabaseFacade.getMetadata();
	}
...
exports.getProductName = function (datasourceName) {
	let productName;
	if (datasourceName) {
		productName = org.eclipse.dirigible.components.api.db.DatabaseFacade.getProductName(datasourceName);
	} else {
		productName = org.eclipse.dirigible.components.api.db.DatabaseFacade.getProductName();
	}
	return productName;
};

exports.getConnection = function (datasourceName) {
	const connection = new Connection();
	var native;
	if (datasourceName) {
		native = org.eclipse.dirigible.components.api.db.DatabaseFacade.getConnection(datasourceName);
	} else {
		native = org.eclipse.dirigible.components.api.db.DatabaseFacade.getConnection();
	}
