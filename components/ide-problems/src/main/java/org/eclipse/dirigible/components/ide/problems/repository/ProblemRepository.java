...
public interface ProblemRepository extends JpaRepository<Problem, Long> {
	...
	List<Problem> findProblemsByLocationAndTypeAndCategory(@Param("location") String location, @Param("type") String type, @Param("category") String category);
	 ...
	 */
	@Modifying
	@Query(value = "UPDATE DIRIGIBLE_PROBLEMS "
			+ "SET PROBLEM_CAUSE = :cause "
			+ "WHERE "
			+ "PROBLEM_LOCATION = :location "
			+ "AND PROBLEM_TYPE = :type "
			+ "AND PROBLEM_CATEGORY = :category ", nativeQuery = true)
	void updateProblemsCauseByLocationAndTypeAndCategory(@Param("cause") String cause, @Param("location") String location, @Param("type") String type, @Param("category") String category);
	 ...
	 */
	@Modifying
	@Query(value = "DELETE FROM DIRIGIBLE_PROBLEMS "
			+ "WHERE "
			+ "PROBLEM_LOCATION = :location "
			+ "AND PROBLEM_TYPE = :type "
			+ "AND PROBLEM_CATEGORY = :category ", nativeQuery = true)
	void deleteProblemsByLocationAndTypeAndCategory( @Param("location") String location, @Param("type") String type, @Param("category") String category);
