...
public class SelectTest {
	...
	public void selectWhereExpr() {
		String sql = Squle.getNative(new SybaseSquleDialect())
			...
			.column("*")
			.from("CUSTOMERS")
			.where(Squle.getNative(new SybaseSquleDialect()).expr().and("PRICE > ?").or("AMOUNT < ?").toString())
			.toString();
	...
	public void selectUnion() {
		String sql = Squle.getNative(new SybaseSquleDialect())
			...
			.column("COUNTRY")
			.from("CUSTOMERS")
			.union(Squle.getNative(new SybaseSquleDialect()).select().column("COUNTRY").from("SUPPLIERS").toString())
			.toString();
