...
public class SelectTest {
	...
	public void selectWhereExpr() {
		String sql = Squle.getNative(new DerbySquleDialect())
			...
			.column("*")
			.from("CUSTOMERS")
			.where(Squle.getNative(new DerbySquleDialect()).expr().and("PRICE > ?").or("AMOUNT < ?").toString())
			.toString();
	...
	public void selectUnion() {
		String sql = Squle.getNative(new DerbySquleDialect())
			...
			.column("COUNTRY")
			.from("CUSTOMERS")
			.union(Squle.getNative(new DerbySquleDialect()).select().column("COUNTRY").from("SUPPLIERS").toString())
			.toString();
