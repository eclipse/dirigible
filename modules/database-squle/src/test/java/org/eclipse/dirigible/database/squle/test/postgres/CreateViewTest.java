...
public class CreateViewTest extends CreateTableTest {
	...
	public void createViewAsSelect() {
		createTableGeneric();
		String sql = Squle.getNative(new PostgresSquleDialect()).create().view("CUSTOMERS_VIEW").column("ID").column("FIRST_NAME").column("LAST_NAME")
	...
	public void createViewAsValues() {
		String sql = Squle.getNative(new PostgresSquleDialect()).create().view("STATES").column("STATE")
