...
public class SelectTest {
	...
	public void selectWhereExpr() {
		String sql = Squle.getNative(new PostgresSquleDialect())
			...
			.column("*")
			.from("CUSTOMERS")
			.where(Squle.getNative(new PostgresSquleDialect()).expr().and("PRICE > ?").or("AMOUNT < ?").toString())
			.toString();
	...
	public void selectUnion() {
		String sql = Squle.getNative(new PostgresSquleDialect())
			...
			.column("COUNTRY")
			.from("CUSTOMERS")
			.union(Squle.getNative(new PostgresSquleDialect()).select().column("COUNTRY").from("SUPPLIERS").toString())
			.toString();
