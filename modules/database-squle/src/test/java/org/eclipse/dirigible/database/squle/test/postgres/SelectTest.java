...
public class SelectTest {
	...
	public void selectWhereExpr() {
		String sql = Squle.getNative(new PostgresSquleDialect())
			...
			.column("*")
			.from("CUSTOMERS")
			.where(Squle.getNative(new PostgresSquleDialect()).expression().and("PRICE > ?").or("AMOUNT < ?").build())
			.build();
	...
	public void selectUnion() {
		String sql = Squle.getNative(new PostgresSquleDialect())
			...
			.column("COUNTRY")
			.from("CUSTOMERS")
			.union(Squle.getNative(new PostgresSquleDialect()).select().column("COUNTRY").from("SUPPLIERS").build())
			.build();
