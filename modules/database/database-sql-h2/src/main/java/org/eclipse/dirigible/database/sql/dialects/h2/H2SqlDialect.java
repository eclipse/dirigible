...
public class H2SqlDialect extends
  ...
  public static final Set<String> FUNCTIONS = Collections.synchronizedSet(new HashSet<String>(Arrays.asList(
      new String[] {"abs", "acos", "asin", "atan", "cos", "cosh", "cot", "sin", "sinh", "tan", "tanh", "atan2", "bitand", "bitget",
          "bitnot", "bitor", "bitxor", "lshift", "rshift", "mod", "ceiling", "degrees", "exp", "floor", "ln", "log", "log10", "ora_hash",
          "radians", "sqrt", "pi", "power", "rand", "random_uuid", "round", "roundmagic", "secure_rand", "sign", "encrypt", "decrypt",
          "hash", "truncate", "compress", "expand", "zero", "ascii", "bit_length", "length", "octet_length", "char", "concat", "concat_ws",
          "difference", "hextoraw", "rawtohex", "instr", "lower", "upper", "left", "right", "locate", "position", "lpad", "rpad", "ltrim",
          "rtrim", "trim", "regexp_replace", "regexp_like", "repeat", "replace", "soundex", "space", "stringdecode", "stringencode",
          "stringtoutf8", "substring", "utf8tostring", "quote_ident", "xmlattr", "xmlnode", "xmlcomment", "xmlcdata", "xmlstartdoc",
          "xmltext", "to_char", "translate", "current_date", "current_time", "current_timestamp", "localtime", "localtimestamp", "dateadd",
          "datediff", "dayname", "day_of_month", "day_of_week", "iso_day_of_week", "day_of_year", "extract", "formatdatetime", "hour",
          "minute", "month", "monthname", "parsedatetime", "quarter", "second", "week", "iso_week", "year", "iso_year", "array_get",
          "array_length", "array_contains", "array_cat", "array_append", "array_slice", "autocommit", "cancel_session", "cast", "coalesce",
          "convert", "currval", "csvread", "csvwrite", "current_schema", "current_catalog", "database_path", "decode", "disk_space_used",
          "signal", "estimated_envelope", "file_read", "file_write", "greatest", "identity", "ifnull", "least", "lock_mode", "lock_timeout",
          "link_schema", "memory_free", "memory_used", "nextval", "nullif", "nvl2", "readonly", "rownum", "scope_identity", "session_id",
          "set", "table", "transaction_id", "truncate_value", "unnest", "user", "h2version", "json functions", "json_object", "json_array",
