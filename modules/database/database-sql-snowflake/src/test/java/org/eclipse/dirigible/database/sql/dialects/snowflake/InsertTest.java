...
public class InsertTest {
	...
	public void insertSimple() {
		String sql =
				SqlFactory.getNative(new SnowflakeSqlDialect()).insert().into("CUSTOMERS").column("FIRST_NAME").column("LAST_NAME").build();
	...
	public void insertSelect() {
		String sql = SqlFactory	.getNative(new SnowflakeSqlDialect())
								...
								.column("FIRST_NAME")
								.column("LAST_NAME")
								.select(SqlFactory.getNative(new SnowflakeSqlDialect()).select().column("*").from("SUPPLIERS").build())
								.toString();
