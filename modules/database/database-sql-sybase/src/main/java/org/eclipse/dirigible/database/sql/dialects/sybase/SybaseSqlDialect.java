...
public class SybaseSqlDialect extends
  ...
  public static final Set<String> FUNCTIONS = Collections.synchronizedSet(new HashSet<String>(Arrays.asList(new String[] {"abs", "acos",
      ...
      "byte_substr64", "cast", "ceil", "ceiling", "char", "char_length", "char_length64", "charindex", "coalesce", "col_length", "col_name",
      "connection_property", "convert", "corr", "cos", "cot", "covar_pop", "covar_samp", "count", "cume_dist", "date", "dateadd",
      "dateceiling", "datediff", "datefloor", "dateformat", "datename", "datepart", "dateround", "datetime", "day", "dayname", "days",
      "db_id", "db_name", "db_property", "degrees", "dense_rank", "difference", "dow", "errormsg", "event_condition",
      "event_condition_name", "event_parameter", "exp", "exp_weighted_avg", "first_value", "floor", "getdate", "graphical_plan", "grouping",
      "group_member", "hextobigint", "hextoint", "hour", "hours", "html_decode", "html_encode", "html_plan", "http_decode", "http_encode",
      "http_header", "http_variable", "ifnull", "index_col", "insertstr", "inttohex", "isdate", "isnull", "isnumeric", "lag", "last_value",
      "lcase", "lead", "left", "len", "length", "list", "ln", "locate", "log", "log10", "lower", "ltrim", "max", "median", "min", "minute",
      "minutes", "mod", "month", "monthname", "months", "newid", "next_connection", "next_database", "next_http_header",
      "next_http_variable", "now", "ntile", "nullif", "number", "object_id", "object_name", "octet_length", "patindex", "percent_rank",
      "percentile_cont", "percentile_disc", "pi", "power", "property", "property_description", "property_name", "property_number",
      "quarter", "radians", "rand", "rank", "regr_avgx", "regr_avgy", "regr_count", "regr_intercept", "regr_r2", "regr_slope", "regr_sxx",
      "regr_sxy", "regr_syy", "remainder", "repeat", "replace", "replicate", "reverse", "right", "round", "row_number", "rowid", "rtrim",
      "second", "seconds", "sign", "similar", "sin", "sortkey", "soundex", "space", "sqlflagger", "sqrt", "square", "stddev", "stddev_pop",
      "stddev_samp", "str", "str_replace", "string", "strtouuid", "stuff", "substring", "substring64", "sum", "suser_id", "suser_name",
      "tan", "today", "trim", "truncnum", "ts_arma_ar", "ts_arma_const", "ts_arma_ma", "ts_autocorrelation", "ts_auto_arima",
      "ts_auto_arima_outlier", "ts_auto_arima_result_aic", "ts_auto_arima_result_aicc", "ts_auto_arima_result_bic",
      "ts_auto_arima_result_forecast_value", "ts_auto_arima_result_forecast_error", "ts_auto_arima_result_model_d",
      "ts_auto_arima_result_model_p", "ts_auto_arima_result_model_q", "ts_auto_arima_result_model_s", "ts_auto_arima_result_residual_sigma",
      "ts_auto_uni_ar", "ts_box_cox_xform", "ts_difference", "ts_double_array", "ts_estimate_missing", "ts_garch", "ts_garch_result_a",
      "ts_garch_result_aic", "ts_garch_result_user", "ts_int_array", "ts_lack_of_fit", "ts_lack_of_fit_p", "ts_max_arma_ar",
      "ts_max_arma_const", "ts_max_arma_likelihood", "ts_max_arma_ma", "ts_outlier_identification", "ts_partial_autocorrelation", "ucase",
      "upper", "user_id", "user_name", "uuidtostr", "var_pop", "var_samp", "variance", "weeks", "weighted_avg", "width_bucket", "year",
      "years", "ymd",
