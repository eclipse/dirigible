...
public class DeleteTest {
	...
	public void deleteSimple() {
		String sql = SqlFactory.getNative(new SybaseSqlDialect()).delete().from("CUSTOMERS").build();
	...
	public void deleteWhere() {
		String sql =
				SqlFactory.getNative(new SybaseSqlDialect()).delete().from("CUSTOMERS").where("AGE > ?").where("COMPANY = 'SAP'").build();
