...
public class SelectTest {
	...
	public void selectWhereExpr() {
		String sql = SqlFactory.getNative(new DerbySqlDialect())
			...
			.column("*")
			.from("CUSTOMERS")
			.where(SqlFactory.getNative(new DerbySqlDialect()).expression().and("PRICE > ?").or("AMOUNT < ?").build())
			.build();
	...
	public void selectUnion() {
		String sql = SqlFactory.getNative(new DerbySqlDialect())
			...
			.column("COUNTRY")
			.from("CUSTOMERS")
			.union(SqlFactory.getNative(new DerbySqlDialect()).select().column("COUNTRY").from("SUPPLIERS").build())
			.build();
