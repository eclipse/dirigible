...
public interface ISqlKeywords {
   ...
   */
  public static final List<String> METADATA_TABLE_TYPES = Collections.unmodifiableList(Arrays.asList(METADATA_TABLE, METADATA_VIEW,
      METADATA_ALIAS, METADATA_SYNONYM, METADATA_GLOBAL_TEMPORARY, METADATA_LOCAL_TEMPORARY, METADATA_SYSTEM_TABLE, METADATA_BASE_TABLE));

  /**
   * The Constant METADATA_TABLE_STRUCTURES.
   */
  public static final List<String> METADATA_TABLE_STRUCTURES = Collections.unmodifiableList(
