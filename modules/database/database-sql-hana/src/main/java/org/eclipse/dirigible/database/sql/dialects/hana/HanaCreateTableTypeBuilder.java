...
public class HanaCreateTableTypeBuilder extends CreateTableTypeBuilder {
  ...
  private static final List<DataType> ARGS_DATA_TYPES =
      new ArrayList<>(List.of(DataType.VARCHAR, DataType.CHAR, DataType.NVARCHAR, DataType.ALPHANUM, DataType.SHORTTEXT, DataType.DECIMAL));
