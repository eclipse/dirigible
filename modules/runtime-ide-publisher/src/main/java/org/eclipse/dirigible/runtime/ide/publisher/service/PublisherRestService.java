...
public class PublisherRestService implements IRestService {
	...
	public Response requestPublishing(@PathParam("workspace") String workspace, @PathParam("path") String path, @Context HttpServletRequest request) throws PublisherException, URISyntaxException {
	...
	public Response getRequest(@PathParam("id") long id, @Context HttpServletRequest request) throws PublisherException {
		...
		if (publishRequestDefinition != null) {
			return Response.ok().entity(GsonHelper.GSON.toJson(publishRequestDefinition)).type(ContentTypeHelper.APPLICATION_JSON).build();
		}
	...
	public Response listLog(@Context HttpServletRequest request) throws PublisherException {
		...
		return Response.ok().entity(GsonHelper.GSON.toJson(publishLogDefinitions)).type(ContentTypeHelper.APPLICATION_JSON).build();
	}
