...
import org.eclipse.dirigible.afterburner.web.dirigible.JavaScriptWebHandler;
...
@Path("/js/blocking")
@ApplicationScoped
public class BlockingJavaScriptWebService extends AbstractRestService {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.eclipse.dirigible.afterburner.web.dirigible.JavaScriptWebService.class.getCanonicalName());
    ...
    public Class<? extends IRestService> getType() {
        return org.eclipse.dirigible.afterburner.web.dirigible.JavaScriptWebService.class;
    }
}
