...
public class WrappedDataSource implements DataSource {
	...
	protected void initAutoCommitEnabled() {
		String param = Configuration.get(IDatasource.DIRIGIBLE_DATASOURCE_SET_AUTO_COMMIT);
		if (param != null) {
	...
	protected void initMaxConnectionsCount() {
		String param = Configuration.get(IDatasource.DIRIGIBLE_DATASOURCE_MAX_CONNECTIONS_COUNT);
		if (param != null) {
	...
	protected void initWaitTimeout() {
		String param = Configuration.get(IDatasource.DIRIGIBLE_DATASOURCE_WAIT_TIMEOUT);
		if (param != null) {
	...
	protected void initWaitCount() {
		String param = Configuration.get(IDatasource.DIRIGIBLE_DATASOURCE_WAIT_COUNT);
		if (param != null) {
