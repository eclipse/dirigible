...
public final class SQLUtils {
  ...
  public static String assertParametersCount(String sql, List<SQLStatementParam> params) {
    ...
    if (count != params.size()) {
      throw new IllegalStateException("The count of the ? symbols in the generated SQL " + sql + " does not match the existing params "
          + params + ". Make sure that the count is the same");
    }
    return sql;
  }
