...
public class EdmTableBinding extends Mapping {
  ...
  private static final String NO_PROPERTY_FOUND =
      "No sql binding configuration found in the mapping configuration for property %s." + " Did you map this property in the %s mapping?";
