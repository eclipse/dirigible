...
public class ContentTypeHelper {
    ...
    /** The Constant APPLICATION_JSON_REPORT. */
    public static final String APPLICATION_JSON_REPORT = "application/json+report";

    /** The Constant APPLICATION_JSON_DASHBOARD. */
    public static final String APPLICATION_JSON_DASHBOARD = "application/json+dashboard";
    ...
    static {
        ...
        TEXT_CONTENT_TYPES.put("dashboard", APPLICATION_JSON_DASHBOARD); //$NON-NLS-1$
