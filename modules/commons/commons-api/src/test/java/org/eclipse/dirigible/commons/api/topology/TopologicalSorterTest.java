...
public class TopologicalSorterTest {
	...
	public void test() {
		...
		List<ITopologicallySortable> list = new ArrayList<>();
//		list.add(nodeG);
//		list.add(nodeB);
//		list.add(nodeH);
//		list.add(nodeA);
...
//		list.add(nodeC);
		...
		List<ITopologicallySortable> results = sorter.sort(list);
		for (ITopologicallySortable sortable : results) {
...
//		G_F
	...
	public static class SortableNode implements ITopologicallySortable {
		
		public String id;
		
		public List<ITopologicallySortable> dependencies;
		
		public SortableNode(String id, ITopologicallySortable ... dependencies) {
			this.id = id;
