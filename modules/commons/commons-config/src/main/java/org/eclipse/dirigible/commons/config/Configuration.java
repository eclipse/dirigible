...
/**
 * Configuration Facade class keeps all the configurations in the Dirigible instance It has the default built in properties file -
 * dirigible.properties After the initialization, all the default properties are replaced with the ones coming as: 1. System's properties 2.
 * Environment variables This can be triggered programmatically with update() method It supports also loading of custom properties files
 * from the class loader with load() for the modules and also merge with a provided properties object with add() methods
 */
public class Configuration {
    ...
    public static final String SYNCHRONIZER_FREQUENCY = "DIRIGIBLE_SYNCHRONIZER_FREQUENCY";
    /** The Constant logger. */
    ...
    private static final String[] CONFIGURATION_PARAMETERS =
            {"DIRIGIBLE_ANONYMOUS_USER_NAME_PROPERTY_NAME", "DIRIGIBLE_BRANDING_NAME", "DIRIGIBLE_BRANDING_BRAND",
                    "DIRIGIBLE_BRANDING_ICON", "DIRIGIBLE_BRANDING_WELCOME_PAGE_DEFAULT", "DIRIGIBLE_GIT_ROOT_FOLDER",
                    ...
                    "DIRIGIBLE_MASTER_REPOSITORY_PROVIDER", "DIRIGIBLE_MASTER_REPOSITORY_ZIP_LOCATION",
                    "DIRIGIBLE_MASTER_REPOSITORY_JAR_PATH", "DIRIGIBLE_REPOSITORY_SEARCH_ROOT_FOLDER",
                    "DIRIGIBLE_REPOSITORY_SEARCH_ROOT_FOLDER_IS_ABSOLUTE", "DIRIGIBLE_REPOSITORY_SEARCH_INDEX_LOCATION",
                    "DIRIGIBLE_REPOSITORY_VERSIONING_ENABLED", "DIRIGIBLE_DATABASE_PROVIDER", "DIRIGIBLE_DATABASE_DEFAULT_SET_AUTO_COMMIT",
                    "DIRIGIBLE_DATABASE_DEFAULT_MAX_CONNECTIONS_COUNT", "DIRIGIBLE_DATABASE_DEFAULT_WAIT_TIMEOUT",
                    "DIRIGIBLE_DATABASE_DEFAULT_WAIT_COUNT", "DIRIGIBLE_DATABASE_CUSTOM_DATASOURCES",
                    "DIRIGIBLE_DATABASE_DATASOURCE_NAME_DEFAULT", "DIRIGIBLE_DATABASE_NAMES_CASE_SENSITIVE",
                    "DIRIGIBLE_DATABASE_DERBY_ROOT_FOLDER_DEFAULT", "DIRIGIBLE_DATABASE_H2_ROOT_FOLDER_DEFAULT",
                    "DIRIGIBLE_DATABASE_H2_DRIVER", "DIRIGIBLE_DATABASE_H2_URL", "DIRIGIBLE_DATABASE_H2_USERNAME",
                    "DIRIGIBLE_DATABASE_H2_PASSWORD", "DIRIGIBLE_DATABASE_TRANSFER_BATCH_SIZE", "DIRIGIBLE_PERSISTENCE_CREATE_TABLE_ON_USE",
                    "DIRIGIBLE_MONGODB_CLIENT_URI", "DIRIGIBLE_MONGODB_DATABASE_DEFAULT", "DIRIGIBLE_SCHEDULER_MEMORY_STORE",
                    "DIRIGIBLE_SCHEDULER_DATASOURCE_TYPE", "DIRIGIBLE_SCHEDULER_DATASOURCE_NAME", "DIRIGIBLE_SCHEDULER_DATABASE_DELEGATE",
                    "DIRIGIBLE_SCHEDULER_LOGS_RETANTION_PERIOD", "DIRIGIBLE_SCHEDULER_EMAIL_SENDER", "DIRIGIBLE_SCHEDULER_EMAIL_RECIPIENTS",
                    "DIRIGIBLE_SCHEDULER_EMAIL_SUBJECT_ERROR", "DIRIGIBLE_SCHEDULER_EMAIL_SUBJECT_NORMAL",
                    "DIRIGIBLE_SCHEDULER_EMAIL_TEMPLATE_ERROR", "DIRIGIBLE_SCHEDULER_EMAIL_TEMPLATE_NORMAL",
                    "DIRIGIBLE_SCHEDULER_EMAIL_URL_SCHEME", "DIRIGIBLE_SCHEDULER_EMAIL_URL_HOST", "DIRIGIBLE_SCHEDULER_EMAIL_URL_PORT",
                    "DIRIGIBLE_SYNCHRONIZER_IGNORE_DEPENDENCIES", "DIRIGIBLE_SYNCHRONIZER_EXCLUDE_PATHS", "DIRIGIBLE_HOME_URL",
                    "DIRIGIBLE_JOB_EXPRESSION_BPM", "DIRIGIBLE_JOB_EXPRESSION_DATA_STRUCTURES", "DIRIGIBLE_JOB_EXPRESSION_EXTENSIONS",
                    "DIRIGIBLE_JOB_EXPRESSION_JOBS", "DIRIGIBLE_JOB_EXPRESSION_MESSAGING", "DIRIGIBLE_JOB_EXPRESSION_MIGRATIONS",
                    "DIRIGIBLE_JOB_EXPRESSION_ODATA", "DIRIGIBLE_JOB_EXPRESSION_PUBLISHER", "DIRIGIBLE_JOB_EXPRESSION_SECURITY",
                    "DIRIGIBLE_JOB_EXPRESSION_REGISTRY", "DIRIGIBLE_JOB_DEFAULT_TIMEOUT", "DIRIGIBLE_CMS_PROVIDER",
                    "DIRIGIBLE_CMS_ROLES_ENABLED", "DIRIGIBLE_CMS_INTERNAL_ROOT_FOLDER", "DIRIGIBLE_CMS_INTERNAL_ROOT_FOLDER_IS_ABSOLUTE",
                    "DIRIGIBLE_CMS_INTERNAL_VERSIONING_ENABLED", "DIRIGIBLE_CMS_MANAGED_CONFIGURATION_JNDI_NAME",
                    ...
                    "DIRIGIBLE_FLOWABLE_USE_SYSTEM_DATASOURCE", "DIRIGIBLE_MESSAGING_USE_DEFAULT_DATABASE",
                    "DIRIGIBLE_KAFKA_BOOTSTRAP_SERVER", "DIRIGIBLE_KAFKA_ACKS", "DIRIGIBLE_KAFKA_KEY_SERIALIZER",
                    "DIRIGIBLE_KAFKA_VALUE_SERIALIZER", "DIRIGIBLE_KAFKA_AUTOCOMMIT_ENABLED", "DIRIGIBLE_KAFKA_AUTOCOMMIT_INTERVAL",
                    "DIRIGIBLE_JAVASCRIPT_ENGINE_TYPE_DEFAULT", "DIRIGIBLE_JAVASCRIPT_GRAALVM_DEBUGGER_PORT",
                    "DIRIGIBLE_JAVASCRIPT_GRAALVM_ALLOW_HOST_ACCESS", "DIRIGIBLE_JAVASCRIPT_GRAALVM_ALLOW_CREATE_THREAD",
                    "DIRIGIBLE_JAVASCRIPT_GRAALVM_ALLOW_CREATE_PROCESS", "DIRIGIBLE_JAVASCRIPT_GRAALVM_ALLOW_IO",
                    "DIRIGIBLE_JAVASCRIPT_GRAALVM_COMPATIBILITY_MODE_NASHORN", "DIRIGIBLE_JAVASCRIPT_GRAALVM_COMPATIBILITY_MODE_MOZILLA",
                    "DIRIGIBLE_OPERATIONS_LOGS_ROOT_FOLDER_DEFAULT", "DIRIGIBLE_THEME_DEFAULT", "DIRIGIBLE_GENERATE_PRETTY_NAMES",
                    "DIRIGIBLE_OAUTH_ENABLED", "DIRIGIBLE_OAUTH_AUTHORIZE_UR", "DIRIGIBLE_OAUTH_TOKEN_URL", "DIRIGIBLE_OAUTH_CLIENT_ID",
                    "DIRIGIBLE_OAUTH_CLIENT_SECRET", "DIRIGIBLE_OAUTH_VERIFICATION_KEY", "DIRIGIBLE_OAUTH_APPLICATION_NAME",
                    "DIRIGIBLE_OAUTH_APPLICATION_HOST", "DIRIGIBLE_OAUTH_ISSUER", "DIRIGIBLE_OAUTH_AUTHORIZE_URL",
                    "DIRIGIBLE_OAUTH_TOKEN_REQUEST_METHOD", "DIRIGIBLE_OAUTH_VERIFICATION_KEY", "DIRIGIBLE_OAUTH_VERIFICATION_KEY_EXPONENT",
                    "DIRIGIBLE_OAUTH_CHECK_ISSUER_ENABLED", "DIRIGIBLE_OAUTH_CHECK_AUDIENCE_ENABLED", "DIRIGIBLE_OAUTH_APPLICATION_NAME",
                    "DIRIGIBLE_PRODUCT_NAME", "DIRIGIBLE_PRODUCT_VERSION", "DIRIGIBLE_PRODUCT_REPOSITORY", "DIRIGIBLE_PRODUCT_COMMIT_ID",
                    "DIRIGIBLE_PRODUCT_TYPE", "DIRIGIBLE_INSTANCE_NAME", "DIRIGIBLE_SPARK_CLIENT_URI",
                    ...
                    "DIRIGIBLE_DESTINATION_CLIENT_SECRET", "DIRIGIBLE_DESTINATION_URL", "DIRIGIBLE_DESTINATION_URI",
                    "DIRIGIBLE_BASIC_ENABLED", BASIC_USERNAME, BASIC_PASSWORD, "DIRIGIBLE_FTP_USERNAME", "DIRIGIBLE_FTP_PASSWORD",
    ...
    /**
     * Configure a runtime object from configuration sources. The parameter patterns are: 1) ${CONFIGURATION_PARAMETER} 2)
