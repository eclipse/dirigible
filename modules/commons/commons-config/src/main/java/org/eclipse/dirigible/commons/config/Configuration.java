...
public class Configuration {
    ...
    public static final String SINGLE_TENANT_MODE_ENABLED = "DIRIGIBLE_SINGLE_TENANT_MODE_ENABLED";
    ...
    private static final String[] CONFIGURATION_PARAMETERS = {SINGLE_TENANT_MODE_ENABLED, "DIRIGIBLE_ANONYMOUS_USER_NAME_PROPERTY_NAME",
            ...
            "DIRIGIBLE_PRODUCT_TYPE", "DIRIGIBLE_INSTANCE_NAME", "DIRIGIBLE_SPARK_CLIENT_URI", "DIRIGIBLE_EXEC_COMMAND_LOGGING_ENABLED",
            "DIRIGIBLE_TERMINAL_ENABLED", "DIRIGIBLE_MAIL_CONFIG_PROVIDER", "DIRIGIBLE_MAIL_USERNAME", "DIRIGIBLE_MAIL_PASSWORD",
            "DIRIGIBLE_MAIL_TRANSPORT_PROTOCOL", "DIRIGIBLE_MAIL_SMTPS_HOST", "DIRIGIBLE_MAIL_SMTPS_PORT", "DIRIGIBLE_MAIL_SMTPS_AUTH",
