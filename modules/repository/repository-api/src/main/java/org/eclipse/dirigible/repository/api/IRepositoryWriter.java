...
public interface IRepositoryWriter {
     ...
     * <p>
     * The returned value is an instance of <code>IResource</code> that represents
    ...
    /**
     * This method creates a new resource at the specified path and fills it with
    ...
    /**
     * Check if Link exists between folder or file and an internal Repository
     * artifact.
     *
     * @param repositoryPath the relative path
