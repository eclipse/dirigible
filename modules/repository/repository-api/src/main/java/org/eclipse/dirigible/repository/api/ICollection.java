...
public interface ICollection extends IEntity {
     ...
     * @throws RepositoryReadException in case the list of {@link ICollection}
     * cannot be retrieved
     */
     ...
     * @return an {@link ICollection} instance.
     * @throws RepositoryReadException in case the {@link ICollection} cannot be
     * retrieved
     */
     ...
     * @throws RepositoryWriteException in case the {@link ICollection}cannot be
     * removed
     */
     ...
     * @throws RepositoryReadException in case the list of {@link IResource} cannot
     * be retrieved
     */
    public List<IResource> getResources() throws RepositoryReadException;

    /**
     * Returns a list containing the names of all the resources directly contained
     * in this collection.
     *
     * @return a list of {@link IResource} instances names
     * @throws RepositoryReadException in case the list of {@link IResource} names
     * cannot be retrieved
     */
     ...
     * @throws RepositoryReadException in case the {@link IResource} cannot be
     * retrieved
     */
     ...
     * @throws RepositoryWriteException in case the {@link IResource} cannot be
     * removed
     */
     ...
     * @throws RepositoryReadException in case the list of the {@link IEntity}
     * cannot be retrieved
     */
    ...
    /**
     * Create resource under this collection by recognizing the content type and
     * binary flag by its file extension.
     *
     * @param name the name of the {@link IResource}
     * @param content the raw content
     * @return an {@link IResource} instance
