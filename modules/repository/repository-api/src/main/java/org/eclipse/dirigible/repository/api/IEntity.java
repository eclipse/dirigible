...
public interface IEntity {
     ...
     * <p>
     * The result could be <code>null</code> should there be no parent (i.e. this is
     * the root).
     *
    ...
    /**
     * Returns an instance of <code>IEntityInformation</code> through which one can
     * obtain information on the current entity.
     * <p>
     * This method may not return <code>null</code>, however, the contents of the
     * returned {@link IEntityInformation} may return <code>null</code> indicating
     * that a given information is not available.
     *
     * @return an {@link IEntityInformation} instance with the meta-data of the
     * entity
     * @throws RepositoryReadException if for some reason a connection to the
     * backend could not be achieved.
     */
     ...
     * <p>
     * Whether the entity will be created as a resource or a collection depends on
     * whether it is an instance of {@link IResource} or {@link ICollection}.
     *
     * @throws RepositoryWriteException if for some reason a connection to the
     * backend could not be achieved, or if an entity with this path already exists
     * on the backend.
     */
     ...
     * <p>
     * If this entity is of type {@link ICollection}, then all child entities are
     * copied too.
     *
     ...
     * <p>
     * If the entity is a collection, implementations should check to see if it has
     * any child entities.
     * <p>
     * If the entity is a resource, implementations should check to see if it has
     * any content. <br>
