...
public abstract class DatabaseEntity implements IEntity {
	 ...
	 *            the path
	 */
	public DatabaseEntity(DatabaseRepository repository, RepositoryPath path) {
		super();
	...
	public IEntityInformation getInformation() throws RepositoryReadException {
		return new DatabaseEntityInformation(this.path, getLocalObjectSafe());
	}

	/**
	 * Returns the {@link DatabaseObject} that matches this entity's path. If there is
	 ...
	 */
	protected DatabaseObject getLocalObject() throws RepositoryReadException {
		try {
	 ...
	 * thrown.
	 *
	 * @return the {@link DatabaseObject} that matches this entity's path
	 * @throws RepositoryNotFoundException
	 *             If there is no such object in the real repository
	 */
	protected DatabaseObject getLocalObjectSafe() throws RepositoryNotFoundException {
		final DatabaseObject result = getLocalObject();
		if (result == null) {
	...
	public boolean equals(Object obj) {
		...
		final DatabaseEntity other = (DatabaseEntity) obj;
