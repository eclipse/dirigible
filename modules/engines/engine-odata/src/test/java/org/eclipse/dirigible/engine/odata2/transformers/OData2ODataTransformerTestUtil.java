...
public class OData2ODataTransformerTestUtil {
    ...
    public static ODataDefinition loadData_testTransformEntityProperty(DBMetadataUtil dbMetadataUtil) throws SQLException, IOException {
        ...
        PersistenceTableModel model = new PersistenceTableModel("ENTITY1", Arrays.asList(column11, column12, column13, column14), new ArrayList<>(), new ArrayList<>());
        ...
        model = new PersistenceTableModel("ENTITY2", Arrays.asList(column13, column4, column5, column6, column7, column8), Collections.singletonList(rel), new ArrayList<>());
        ...
        model = new PersistenceTableModel("ENTITY3", Arrays.asList(column24, column25), new ArrayList<>(), new ArrayList<>());
