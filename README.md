...
1. Clone the [project repository - master branch](https://github.com/eclipse/dirigible/tree/master)
   or [download the latest sources](https://github.com/eclipse/dirigible/archive/master.zip).
...
This project is copyrighted by [SAP SE](http://www.sap.com/) or an SAP affiliate company and Eclipse Dirigible
contributors and is available under the [Eclipse Public License v 2.0](https://www.eclipse.org/legal/epl-v20.html).
See [LICENSE.txt](LICENSE.txt) and [NOTICE.txt](NOTICE.txt) for further details.
