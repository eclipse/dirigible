...
(function () {
	...
	let BoardTagDAO = exports.BoardTagDAO = function (orm, boardDao, tagsDao) {
	...
	BoardTagDAO.prototype.listJoins = function (settings, daos) {
		...
		try {
			...
			let resultSet = this.execute(qb, parameterBindings);
	...
	exports.create = function (boardDao, tagsDao) {
		let boardTagDAO = new BoardTagDAO(BoardTagsORM, boardDao, tagsDao);
		return boardTagDAO;
	};
})();