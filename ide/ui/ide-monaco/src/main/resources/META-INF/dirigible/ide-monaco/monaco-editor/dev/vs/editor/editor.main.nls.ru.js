...
define("vs/editor/editor.main.nls.ru", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Явные параметры для функций шрифтов.",
		"Настраивает лигатуры.",
		...
		"Масштаб содержимого, выводимого на мини-карте.",
		...
		"Определяет, следует ли выделять неожиданные изменения текста при принятии вариантов завершения, например, для замены необходим вариант \"insertMode\", но завершение поддерживает только вариант \"insert\".",
		...
		"Задает количество строк в редакторе, которые могут быть прочитаны средством чтения с экрана. Предупреждение: из-за технических ограничений этот число не может превышать значение по умолчанию.",
	...
	"vs/editor/contrib/codeAction/lightBulbWidget": [
		"Отображение исправлений. Доступно предпочитаемое исправление ({0})",
	...
	"vs/editor/contrib/rename/renameInputField": [
		...
		"{0} для переименования, {1} для предварительного просмотра",
	],
	...
	"vs/editor/contrib/suggest/suggestWidget": [
		...
		"{0} для просмотра сокращенных сведений...",
		"{0} для получения дополнительных сведений...",
		"Элемент {0}, документы: {1}",
		"{0} для вставки, {1} для замены",
		"{0} для замены, {1} для вставки",
		"{0} для принятия",
	],
