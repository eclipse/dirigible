...
define("vs/editor/editor.main.nls.it", {
	...
	"vs/base/browser/ui/list/listWidget": [
		"{0}. Usare i tasti di navigazione per spostarsi.",
	],
	...
	"vs/editor/common/config/editorOptions": [
		...
		"L\'editor verrà definitivamente ottimizzato per l\'utilizzo con un\'utilità per la lettura dello schermo.",
		...
		"Controlla se l\'operazione di ricerca viene eseguita all\'interno del testo selezionato o in tutto il file aperto nell\'editor.",
		...
		"Configura i caratteri legatura.",
		...
		"Scala del contenuto disegnato nella minimappa.",
		...
		"Controlla se le modifiche al testo impreviste durante l\'accettazione dei completamenti devono essere evidenziate, ad esempio `insertMode` è `replace` ma il completamento supporta solo `insert`.",
		...
		"Controlla se un frammento attivo previene i suggerimenti rapidi.",
		...
		"Controlla se l\'editor deve racchiudere automaticamente le selezioni tra parentesi quadre o virgolette.",
		...
		"Controlla in che modo vengono calcolati gli intervalli di riduzione. Con `auto` viene usata la strategia di riduzione specifica della lingua. Con `indentation` viene usata forzatamente la strategia di riduzione basata sui rientri.",
	...
	"vs/editor/common/standaloneStrings": [
		...
		"Vai alla riga {0} e carattere {1}",
		"Vai alla riga {0}",
		"Digitare un numero di riga a cui passare compreso tra 1 e {0}",
		"Digitare un carattere compreso tra 1 e {0} a cui passare",
		"Riga corrente: {0}. Passa a riga {1}.",
		"Digitare un numero di riga, seguito da due punti facoltativi e da un numero di carattere a cui passare",
		"Vai alla riga...",
		"{0}, {1}, comandi",
		"{0}, comandi",
		...
		"chiamate ({0})",
		"Contenuto editor",
		"Premere CTRL+F1 per le opzioni di accessibilità.",
	...
	"vs/editor/contrib/gotoSymbol/goToCommands": [
		...
		"Posizioni",
		"Non sono stati trovati risultati per \'{0}\'",
		"Riferimenti",
	],
	...
	"vs/editor/contrib/rename/renameInputField": [
		...
		"{0} da rinominare, {1} da visualizzare in anteprima",
	],
	...
	"vs/editor/contrib/suggest/suggestWidget": [
		...
		"{0} per meno...",
		"{0} per altro...",
		"Elemento {0}, documenti: {1}",
		"{0} per inserire, {1} per sostituire",
		"{0} da sostituire, {1} da inserire",
		"{0} per accettare",
	],
	...
	"vs/platform/list/browser/listService": [
		...
		"Controlla se elenchi e alberi supportano lo scorrimento orizzontale in Workbench.",
		"Controlla se gli alberi supportano lo scorrimento orizzontale in Workbench.",
		"Questa impostazione è deprecata. In alternativa, usare \'{0}\'.",
