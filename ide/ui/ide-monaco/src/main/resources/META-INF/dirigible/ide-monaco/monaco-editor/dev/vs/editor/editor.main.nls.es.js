...
define("vs/editor/editor.main.nls.es", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Configura ligaduras de fuentes.",
		...
		"Escala del contenido dibujado en el minimapa.",
		...
		"Controla si se deben destacar las modificaciones inesperadas en el texto mientras se aceptan las finalizaciones, por ejemplo, \"insertMode\" es \"replace\", pero la finalización solo es compatible con \"insert\".",
	...
	"vs/editor/contrib/gotoSymbol/goToCommands": [
		...
		"Ubicaciones",
		"No hay ningún resultado para \"{0}\".",
		"Referencias",
	],
