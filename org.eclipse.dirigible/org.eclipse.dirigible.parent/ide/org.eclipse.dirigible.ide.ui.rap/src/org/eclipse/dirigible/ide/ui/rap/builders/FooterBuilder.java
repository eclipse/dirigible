...
public class FooterBuilder extends ElementBuilder {
	...
	private void initLayoutData() {
		...
		left = createImage(set.getImagePath(LayoutSetConstants.FOOTER_LEFT));
		bg = createImage(set.getImagePath(LayoutSetConstants.FOOTER_BG));
		right = createImage(set.getImagePath(LayoutSetConstants.FOOTER_RIGHT));
	}
