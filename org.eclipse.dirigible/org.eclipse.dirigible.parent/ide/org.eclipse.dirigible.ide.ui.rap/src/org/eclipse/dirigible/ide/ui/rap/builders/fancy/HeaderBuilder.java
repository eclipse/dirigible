 ...
 *******************************************************************************/
package org.eclipse.dirigible.ide.ui.rap.builders.fancy;
...
public class HeaderBuilder extends ElementBuilder {
	...
	private void initLayoutData() {
		...
		// images
		leftBg = createImage(set
				.getImagePath(LayoutSetConstants.HEADER_LEFT_BG));
		rightBg = createImage(set
				.getImagePath(LayoutSetConstants.HEADER_RIGHT_BG));
		wave = createImage(set.getImagePath(LayoutSetConstants.HEADER_WAVE));

		// logo
		ElementBuilder builder = new DummyBuilder(null,
				LayoutSetConstants.SET_ID_LOGO);
		logo = builder.getImage(LayoutSetConstants.LOGO);
		// positions
		LayoutSet layoutSet = (LayoutSet) builder.getAdapter(LayoutSet.class);
		fdLogo = layoutSet.getPosition(LayoutSetConstants.LOGO_POSITION);
	}
