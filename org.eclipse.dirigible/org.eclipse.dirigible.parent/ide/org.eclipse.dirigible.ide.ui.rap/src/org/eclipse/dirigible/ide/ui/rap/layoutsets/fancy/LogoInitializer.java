...
public class LogoInitializer implements ILayoutSetInitializer {
	...
	public void initializeLayoutSet(final LayoutSet layoutSet) {
		layoutSet.addImagePath(LayoutSetConstants.LOGO,
				LayoutSetConstants.IMAGE_PATH_FANCY + "logo.png"); //$NON-NLS-1$

		// positions
		FormData fdLogo = new FormData();
		fdLogo.right = new FormAttachment(100, -30);
		fdLogo.top = new FormAttachment(0, 57);
		layoutSet.addPosition(LayoutSetConstants.LOGO_POSITION, fdLogo);
	}
}
