...
public class StackPresentationBuider extends ElementBuilder {
	...
	private void init() {
		tabInactiveBgActive = createImageById(LayoutSetConstants.STACK_TAB_INACTIVE_BG_ACTIVE);
		borderBottom = createImageById(LayoutSetConstants.STACK_BORDER_BOTTOM);
		borderTop = createImageById(LayoutSetConstants.STACK_BORDER_TOP);
		borderLeft = createImageById(LayoutSetConstants.STACK_BORDER_LEFT);
		borderRight = createImageById(LayoutSetConstants.STACK_BORDER_RIGHT);
		leftCorner = createImageById(LayoutSetConstants.STACK_TABBAR_LEFT_ACTIVE);
		rightCorner = createImageById(LayoutSetConstants.STACK_TABBAR_RIGHT_ACTIVE);
	}
