 ...
 *******************************************************************************/
package org.eclipse.dirigible.ide.ui.rap.shared;

public interface LayoutSetConstants {
	/*
	 * Image paths
	 */
	 ...
	 * LayoutSet Ids
	 */
	public static final String SET_ID_CONFIG_DIALOG = "org.eclipse.dirigible.ide.ui.rap.layoutsets.fancy.configdialog"; //$NON-NLS-1$
	public static final String SET_ID_COOLBAR = "org.eclipse.dirigible.ide.ui.rap.layoutsets.fancy.coolbar"; //$NON-NLS-1$
	public static final String SET_ID_OVERFLOW = "org.eclipse.dirigible.ide.ui.rap.layoutsets.fancy.coolbaroverflow"; //$NON-NLS-1$
	public static final String SET_ID_FOOTER = "org.eclipse.dirigible.ide.ui.rap.layoutsets.fancy.footer"; //$NON-NLS-1$
	public static final String SET_ID_HEADER = "org.eclipse.dirigible.ide.ui.rap.layoutsets.fancy.header"; //$NON-NLS-1$
	public static final String SET_ID_LOGO = "org.eclipse.dirigible.ide.ui.rap.layoutsets.fancy.Logo"; //$NON-NLS-1$
	public static final String SET_ID_MENUBAR = "org.eclipse.dirigible.ide.ui.rap.layoutsets.fancy.menubar"; //$NON-NLS-1$
	public static final String SET_ID_PERSP = "org.eclipse.dirigible.ide.ui.rap.layoutsets.fancy.perspective"; //$NON-NLS-1$
	public static final String SET_ID_STACKPRESENTATION = "org.eclipse.dirigible.ide.ui.rap.layoutsets.fancy.stack"; //$NON-NLS-1$
	...
	public static final String MENUBAR_POPUP = "menubar.popup"; //$NON-NLS-1$
	public static final String MENUBAR_POPUP_BUTTON = "menubar.popup.button"; //$NON-NLS-1$
	public static final String MENUBAR_TOP_BG = "menubar.popup.top"; //$NON-NLS-1$
	public static final String MENUBAR_BOTTOM_BG = "menubar.popup.bottom"; //$NON-NLS-1$
	public static final String MENUBAR_LEFT_BG = "menubar.popup.left"; //$NON-NLS-1$
	public static final String MENUBAR_RIGHT_BG = "menubar.popup.right"; //$NON-NLS-1$
	public static final String MENUBAR_CORNER_LEFT = "menubar.popup.corner.left"; //$NON-NLS-1$
	public static final String MENUBAR_CORNER_RIGHT = "menubar.popup.corner.right"; //$NON-NLS-1$
	public static final String MENUBAR_SECOND_LAYER_CHEFRON = "menubar.popup.secondlayer"; //$NON-NLS-1$
