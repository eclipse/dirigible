...
/**
* Include the tern.js json definitions with (use your local github root folder for {git_root_dir} placeholder):
 * git clone org.eclipse.orion.client
 * git reset --hard R11_0
 * replace ternDefaults.js
 * 		> cp {git_root_dir}/dirigible/org.eclipse.dirigible/org.eclipse.dirigible.parent/ide/org.eclipse.dirigible.ide.editor.orion/src/org/eclipse/dirigible/ide/editor/orion/api/ternDefaults.js {git_root_dir}/org.eclipse.orion.client/bundles/org.eclipse.orion.client.javascript/web/javascript/plugins/
 * copy dirigible.json
 *      > cp {git_root_dir}/dirigible/org.eclipse.dirigible/org.eclipse.dirigible.parent/ide/org.eclipse.dirigible.ide.editor.orion/src/org/eclipse/dirigible/ide/editor/orion/api/dirigible.json {git_root_dir}/org.eclipse.orion.client/bundles/org.eclipse.orion.client.javascript/web/tern/defs/
 * copy tabris.json
 *      > cp {git_root_dir}/dirigible/org.eclipse.dirigible/org.eclipse.dirigible.parent/ide/org.eclipse.dirigible.ide.editor.orion/src/org/eclipse/dirigible/ide/editor/orion/api/tabris.json {git_root_dir}/org.eclipse.orion.client/bundles/org.eclipse.orion.client.javascript/web/tern/defs/
 * mvn clean install
 * copy codeEdit/* to resources
 *      > cp -r {git_root_dir}/org.eclipse.orion.client/built-js/codeEdit/* {git_root_dir}/dirigible/org.eclipse.dirigible/org.eclipse.dirigible.parent/ide/org.eclipse.dirigible.ide.editor.orion/resources/
 *      > cp -r {git_root_dir}/org.eclipse.orion.client/built-js/codeEdit/* {git_root_dir}/dirigible/org.eclipse.dirigible/org.eclipse.dirigible.parent/runtime/org.eclipse.dirigible.runtime.ui/resources/ui/orion/
 */
