...
//		}
		...
		if ("/org/eclipse/dirigible/ide/template/ui/is/templates/shielding-js.flow" //$NON-NLS-1$
			...
			generateFile(
					"/org/eclipse/dirigible/ide/template/ui/is/templates/javascript-sync.js", //$NON-NLS-1$
		...
		if ("/org/eclipse/dirigible/ide/template/ui/is/templates/trigger-to-javascript.job" //$NON-NLS-1$
			...
			generateFile(
					"/org/eclipse/dirigible/ide/template/ui/is/templates/javascript-async.js", //$NON-NLS-1$
					targetLocationPathJavaScriptServices,
					model.getEndpointAddress()
							+ CommonParameters.JAVASCRIPT_SERVICE_EXTENSION);
		}
