...
public class NewCollectionHandler extends AbstractClipboardHandler {
	...
	protected void execute(ExecutionEvent event, SortedSet<IEntity> resources) {
		...
		InputDialog dlg = new InputDialog(null, "", "Collection Name", "", new PathValidator());
		if (dlg.open() == Window.OK) {
			try {
				repository.createCollection(targetReposiotryPath + IRepository.SEPARATOR + dlg.getValue());
			} catch (IOException e) {
