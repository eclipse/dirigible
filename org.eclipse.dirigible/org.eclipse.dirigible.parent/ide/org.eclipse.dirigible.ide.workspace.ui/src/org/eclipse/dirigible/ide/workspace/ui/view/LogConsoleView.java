...
public class LogConsoleView extends ViewPart {
	...
	static {
		LOGGING_LOCATION = ((CommonParameters.getRuntimeUrl() == null) || "".equals(CommonParameters.getRuntimeUrl()))
				? "/ui/templates/monitoring/logging/log.html" : "/services/ui/templates/monitoring/logging/log.html";
	}
