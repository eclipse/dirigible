...
public final class FileUploadHandler {
	...
	/**
	 * Constructs a file upload handler that is associated with the given
	 * receiver. The receiver is responsible for reading and processing the
	 * uploaded data.
	 * 
	 * @param receiver
	 *            the receiver that should process the uploaded data, must not
	 *            be <code>null</code>
	 */
	...
	/**
	 * Returns the file upload receiver that is associated with this file upload
	 * handler.
	 * 
	...
	/**
	 * Adds a the given file upload listener to the collection of listeners who
	 * will be notified when a file upload proceeds.
	 * 
	 * @param listener
	 *            the file upload listener to add, must not be <code>null</code>
	...
	/**
	 * Removes the given file upload listener from the collection of listeners
	 * who will be notified when a file upload proceeds.
	 * 
	 * @param listener
	 *            the file upload listener to remove, must not be
	 *            <code>null</code>
	...
	/**
	 * Closes and de-registers the upload handler. After calling this method, no
	 * subsequent upload requests for this handler will be accepted anymore.
	 * Clients <em>must</em> call this method before discarding the instance of
	 * the handler to allow it to be garbage collected.
	 */
	public void dispose() {
	...
	/**
	 * Returns the maximum file size in bytes allowed to be uploaded for this
	 * handler. The default value of -1, indicates no limit.
	 * 
	 * @see #setMaxFileSize
	 */
	...
	/**
	 * Sets the maximum file size in bytes allowed to be uploaded for this
	 * handler. A value of -1 indicates no limit.
	 * 
	 * @see #getMaxFileSize
	 */
