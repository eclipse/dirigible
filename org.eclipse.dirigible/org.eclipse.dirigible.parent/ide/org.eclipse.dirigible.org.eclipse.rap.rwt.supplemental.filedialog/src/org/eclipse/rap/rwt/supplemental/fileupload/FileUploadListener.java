 ...
 * <p>
 * <strong>Note:</strong> This listener will be called from a different thread
 * than the UI thread. Implementations must use
 * {@link Display#asyncExec(Runnable)} to access the UI.
 * </p>
 * 
 * @see FileUploadEvent
 */
public interface FileUploadListener {
	 ...
	 * 
	 * @param event
	 *            event object that contains information about the uploaded file
