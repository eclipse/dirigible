...
public class DataStructuresGenerationWorkerProvider implements IGenerationWorkerProvider {
	...
	public String getType() {
		return ICommonConstants.TEMPLATE_TYPE.DATA_STRUCTURES;
	}

	@Override
	public IGenerationWorker createWorker(HttpServletRequest request) throws Exception {
		IGenerationWorker generationWorker = new DatabaseGenerationWorker(GenerationUtils.getRepository(request),
