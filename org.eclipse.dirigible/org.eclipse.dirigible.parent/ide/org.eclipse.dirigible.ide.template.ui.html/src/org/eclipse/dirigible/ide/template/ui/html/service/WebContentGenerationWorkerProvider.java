...
public class WebContentGenerationWorkerProvider implements IGenerationWorkerProvider {

	@Override
	public String getType() {
		return ICommonConstants.TEMPLATE_TYPE.WEB_CONTENT;
	}

	@Override
	public IGenerationWorker createWorker(HttpServletRequest request) throws Exception {
		IGenerationWorker generationWorker = new WebContentGenerationWorker(GenerationUtils.getRepository(request),
