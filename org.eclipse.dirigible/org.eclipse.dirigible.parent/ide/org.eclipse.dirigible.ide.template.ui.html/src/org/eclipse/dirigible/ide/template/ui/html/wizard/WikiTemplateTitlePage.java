...
public class WikiTemplateTitlePage extends FocusableWizardPage {
	...
	private static final String PAGE_NAME = "org.eclipse.dirigible.ide.template.ui.html.wizard.WikiTemplateTitlePage"; //$NON-NLS-1$

	private WikiTemplateModel model;

	private Text pageTitleText;

	protected WikiTemplateTitlePage(WikiTemplateModel model) {
		super(PAGE_NAME);
		this.model = model;
		setTitle(PAGE_TITLE);
