...
import org.eclipse.dirigible.ide.template.ui.common.table.WidgetType;
...
public abstract class WizardForEntityTamplateTablePage extends WizardPage {
	...
	private void createTableField(Composite parent) {
		...
		typeViewer.setLabelProvider(getLabelProvider());
