...
public class ProjectDescription extends ContainerDescription {
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.internal.ide.undo.ContainerDescription#createResourceHandle
	 * ()
	 */
	public IResource createResourceHandle() {
		return RemoteResourcesPlugin.getWorkspace().getRoot()
				.getProject(getName());
	}
	 ...
	 * createExistentResourceFromHandle(org.eclipse.core.resources.IResource,
	...
	public void createExistentResourceFromHandle(IResource resource,
		...
		monitor.beginTask(EMPTY_STRING, 200); //$NON-NLS-1$
		...
		if (openOnCreate) {
			projectHandle.open(IResource.NONE, new SubProgressMonitor(monitor,
					100));
		}
		monitor.done();
	}
