...
public class PathVariablesGroup {
	...
	public PathVariablesGroup(boolean multiSelect, int variableType) {
		...
		pathVariableManager = RemoteResourcesPlugin.getWorkspace()
	...
	public Control createContents(Composite parent) {
		...
		variableTable.addSelectionListener(new SelectionAdapter() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -7320947844740503270L;
	...
	private void createButtonGroup(Composite parent) {
		...
		addButton
				.setText(IDEWorkbenchMessages.PathVariablesBlock_addVariableButton);
		addButton.addSelectionListener(new SelectionAdapter() {
			/**
			 * 
			 */
			private static final long serialVersionUID = -1518049224038781043L;
		...
		editButton
				.setText(IDEWorkbenchMessages.PathVariablesBlock_editVariableButton);
		editButton.addSelectionListener(new SelectionAdapter() {
			/**
			 * 
			 */
			private static final long serialVersionUID = -4334589961501571254L;
		...
		removeButton
				.setText(IDEWorkbenchMessages.PathVariablesBlock_removeVariableButton);
		removeButton.addSelectionListener(new SelectionAdapter() {
			/**
			 * 
			 */
			private static final long serialVersionUID = -6510793783911124015L;
	...
	private void updateVariableTable(String selectedVarName) {
		...
		for (Iterator<String> varNames = tempPathVariables.keySet().iterator(); varNames
				.hasNext();) {
	...
	private GridData setButtonLayoutData(Button button) {
		...
		data.widthHint = Math.max(IDialogConstants.BUTTON_WIDTH,
	 ...
	 * (selects the first item if <code>null</code> is provided) and updates the
	 * enabled state for the Add/Remove/Edit buttons.
	 * 
	 * @param selectedVarName
