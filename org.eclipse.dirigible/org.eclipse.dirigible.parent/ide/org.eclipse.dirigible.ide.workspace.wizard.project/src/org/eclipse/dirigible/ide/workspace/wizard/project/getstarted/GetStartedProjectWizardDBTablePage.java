...
public class GetStartedProjectWizardDBTablePage extends WizardPage {
	...
	private static final Logger logger = Logger
			.getLogger(GetStartedProjectWizardDBTablePage.class);
	...
	private static final String PAGE_NAME = "Database Table Page"; //$NON-NLS-1$

	private static final String CONTENT = "dbtable.html"; //$NON-NLS-1$
	...
	public void createControl(Composite parent) {
		...
		try {
			description = IOUtils.toString(
					GetStartedProjectWizardDBTablePage.class.getResourceAsStream(CONTENT));
		} catch (IOException e) {
