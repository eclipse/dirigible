...
/**
 * Preference Page for the Terminal View related properties
 */
public class TerminalPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	protected void createFieldEditors() {
		...
		enableTimeLimitField = new BooleanFieldEditor(LIMIT_ENABLED, "&Enable Time Limit", getFieldEditorParent());
		enableTimeLimitField.setPreferenceStore(getPreferenceStore());
		enableTimeLimitField.load();
		addField(enableTimeLimitField);

		limitTimeoutField = new IntegerFieldEditor(LIMIT_TIMEOUT, "&Limit Timeout (s):", getFieldEditorParent());
