 ...
 */
public class PublishTemplateCommandHandler extends AbstractHandler {
	...
	private static final Logger logger = Logger.getLogger(PublishTemplateCommandHandler.class);
