...
public class ListenerEventProcessorFactoryOSGi {

	private static final Logger logger = Logger.getLogger(ListenerEventProcessorFactoryOSGi.class);
	...
	public static void registerListenerEventProcessorProviders(BundleContext context) throws InvalidSyntaxException {
		...
		synchronized (ListenerEventProcessorFactoryOSGi.class) {
