...
public class JobRegistryRuntimeServiceDescriptor implements IRuntimeServiceDescriptor {
	...
	private final String name = "Job Registry"; //$NON-NLS-1$
	private final String description = "Job Registry Service lists all the Job declarations.";
	private final String endpoint = "/registry-job"; //$NON-NLS-1$
	private final String documentation = "http://www.dirigible.io/help/service_registry_job.html"; //$NON-NLS-1$
