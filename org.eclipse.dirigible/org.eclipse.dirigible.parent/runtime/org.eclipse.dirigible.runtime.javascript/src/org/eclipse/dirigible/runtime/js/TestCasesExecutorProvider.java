...
public class TestCasesExecutorProvider implements IScriptExecutorProvider {
	...
	public String getType() {
		return ICommonConstants.ENGINE_TYPE.TEST;
	}

	@Override
	public String getAlias() {
		return ICommonConstants.ENGINE_ALIAS.TEST;
	}

	@Override
	public IScriptExecutor createExecutor(HttpServletRequest request) throws IOException {
		TestCasesServlet testCasesServlet = new TestCasesServlet();
		JavaScriptExecutor javaScriptExecutor = testCasesServlet.createExecutor(request);
