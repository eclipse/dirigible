...
public class TestRuntimeServiceDescriptor implements IRuntimeServiceDescriptor {
	...
	private final String name = "Test Execution"; //$NON-NLS-1$
	...
	private final String endpoint = "/test"; //$NON-NLS-1$
	private final String documentation = "http://www.dirigible.io/help/service_test.html"; //$NON-NLS-1$
