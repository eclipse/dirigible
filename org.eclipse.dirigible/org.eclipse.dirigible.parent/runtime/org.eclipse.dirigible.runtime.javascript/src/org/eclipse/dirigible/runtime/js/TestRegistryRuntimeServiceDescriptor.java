...
public class TestRegistryRuntimeServiceDescriptor implements IRuntimeServiceDescriptor {
	...
	private final String name = "Test Registry"; //$NON-NLS-1$
	private final String description = "Test Registry Service lists all the unit tests written in JavaScript.";
	private final String endpoint = "/registry-test"; //$NON-NLS-1$
	private final String documentation = "http://www.dirigible.io/help/service_registry_test.html"; //$NON-NLS-1$
