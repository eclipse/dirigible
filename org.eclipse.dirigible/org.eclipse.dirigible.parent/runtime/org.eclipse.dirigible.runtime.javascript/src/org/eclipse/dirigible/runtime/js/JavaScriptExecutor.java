...
public class JavaScriptExecutor extends AbstractScriptExecutor {
	...
	public Object executeServiceModule(HttpServletRequest request, HttpServletResponse response, Object input, String module,
		...
		try {
			...
			registerDefaultVariables(request, response, input, executionContext, repository, topLevelScope);
	...
	private RepositoryModuleSourceProvider createRepositoryModuleSourceProvider() {
		...
		repositoryModuleSourceProvider = new RepositoryModuleSourceProvider(this, repository, rootPaths);
