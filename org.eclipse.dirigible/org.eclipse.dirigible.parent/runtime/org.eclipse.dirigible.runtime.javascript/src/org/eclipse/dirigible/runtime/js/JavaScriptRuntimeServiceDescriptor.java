...
public class JavaScriptRuntimeServiceDescriptor implements IRuntimeServiceDescriptor {
	...
	private final String name = "JavaScript Execution"; //$NON-NLS-1$
	...
	private final String endpoint = "/js"; //$NON-NLS-1$
	private final String documentation = "http://www.dirigible.io/help/service_javascript.html"; //$NON-NLS-1$
