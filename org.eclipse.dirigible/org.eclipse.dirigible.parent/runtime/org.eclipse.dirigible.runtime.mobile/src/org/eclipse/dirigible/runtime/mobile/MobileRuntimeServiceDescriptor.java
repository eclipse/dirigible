...
public class MobileRuntimeServiceDescriptor implements IRuntimeServiceDescriptor {
	...
	private final String name = "Mobile Execution";
	private final String description = "Mobile Execution Service sends the code for the application written in JavaScript for Mobile.";
