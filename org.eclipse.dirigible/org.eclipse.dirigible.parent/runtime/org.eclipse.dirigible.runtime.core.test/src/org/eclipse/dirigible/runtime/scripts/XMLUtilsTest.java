...
public class XMLUtilsTest {
	...
	public void testFromJson() throws Exception {
		...
		String xml = xmlUtils.fromJson("{" + "  'name':'JSON'," + "  'integer':1," + "  'double':2.0," + "  'boolean':true," + "  'nested':" + "  {"
				+ "    'id':42" + "  }," + "  'array':[1,2,3]" + "}");
	...
	public void testToJson() throws Exception {
		...
		String json = xmlUtils.toJson("<root><nested>" + "  <id>42</id>" + "</nested>" + "<integer>1</integer>" + "<name>JSON</name>"
				+ "<boolean>true</boolean>" + "<double>2.0</double>" + "<array>1</array>" + "<array>2</array>" + "<array>3</array></root>");
		...
		assertTrue(json.contains("\"double\": \"2.0\""));
