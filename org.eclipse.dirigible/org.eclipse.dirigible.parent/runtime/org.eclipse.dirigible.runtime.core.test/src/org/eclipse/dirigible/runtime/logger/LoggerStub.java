...
public class LoggerStub extends Logger {
	...
	public static Logger getLogger(Class<?> clazz) {
		return new LoggerStub(LoggerFactory.getLogger(clazz), java.util.logging.Logger.getLogger(clazz.getCanonicalName()));
	}

	protected LoggerStub(org.slf4j.Logger logger1, java.util.logging.Logger logger2) {
