...
public class ProjectImportRuntimeServiceDescriptor implements IRuntimeServiceDescriptor {
	...
	private final String name = "Project Import"; //$NON-NLS-1$
	...
	private final String endpoint = "/project-import"; //$NON-NLS-1$
	private final String documentation = "http://www.dirigible.io/help/service_project_import.html"; //$NON-NLS-1$
