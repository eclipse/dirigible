...
public class DataExportRuntimeServiceDescriptor implements IRuntimeServiceDescriptor {
	...
	private final String name = "Data Export"; //$NON-NLS-1$
	...
	private final String endpoint = "/data-export"; //$NON-NLS-1$
	private final String documentation = "http://www.dirigible.io/help/service_data_export.html"; //$NON-NLS-1$
