...
const EXT_POINT_NAME = "/registry/extension_points/operate";

const TEMPLATE_START_LOCATION = "/db/dirigible/registry/public/ScriptingServices/registry/extensions/controllers/menu/templates/operate_start.js";
const TEMPLATE_END_LOCATION = "/db/dirigible/registry/public/ScriptingServices/registry/extensions/controllers/menu/templates/operate_end.js";
...
function createItem(extension) {
	var item = {
    	"item": "$scope.operateData.push(" + extension.getItem() + ");\n",
