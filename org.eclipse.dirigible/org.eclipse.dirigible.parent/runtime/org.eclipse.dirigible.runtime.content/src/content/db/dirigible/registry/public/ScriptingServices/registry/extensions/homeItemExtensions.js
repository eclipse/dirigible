...
const EXT_POINT_NAME = "/registry/extension_points/home_item";

const TEMPLATE_START_LOCATION = "/db/dirigible/registry/public/ScriptingServices/registry/templates/controllers/home_start.js";
const TEMPLATE_END_LOCATION = "/db/dirigible/registry/public/ScriptingServices/registry/templates/controllers/home_end.js";
...
function createItem(extension) {
	var item = {
    	"item": "$scope.homeData.push(" + extension.getItem() + ");\n",
