...
class RegistryContent:
    def update(self):
        ...
        self.updateContent('content/templates/ExtensionDefinitions.json')
        self.updateContent('content/templates/IntegrationServices.json')
        self.updateContent('content/templates/MobileApplications.json')
