...
public class CommandServlet extends AbstractScriptingServlet {
	...
	private static final Logger logger = Logger.getLogger(CommandServlet.class.getCanonicalName());
	...
	public CommandExecutor createExecutor(HttpServletRequest request) throws IOException {
		CommandExecutor executor = new CommandExecutor(getRepository(request), getScriptingRegistryPath(request), REGISTRY_SCRIPTING_DEPLOY_PATH);
		return executor;
	}
